 ...
 */
public class NombreVendedor extends javax.swing.JFrame {

    /**
     * Creates new form NombreVendedor
     */
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        String name = nombreVendedor.getText().trim();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NombreVendedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NombreVendedor().setVisible(true);
            }
        });
    }
